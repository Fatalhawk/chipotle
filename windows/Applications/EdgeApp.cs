...
namespace App.Program
{
    class EdgeApp : ProgramBase
    {
        ...
        public EdgeApp(ref Process pObj, IntPtr hWnd, string title) : base(ref pObj, hWnd, title)
        {
        }
